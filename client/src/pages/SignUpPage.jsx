...
const SignUpPage = () => {
    ...
    return (
        <div className="h-full w-full flex justify-center items-center">
            <form onSubmit={handleSubmit((data)=>console.log(data))} className="w-11/12 h-full max-w-[400px] flex flex-col justify-center max-h-[700px] bg-gray-100 rounded-lg border-2 border-gray-300">
